...
const Home = () => {
  ...
  console.log(splideRef?.current?.splide.Components.Arrows.arrows);

  useEffect(() => {
    if (splideRef.current) {
      // Accede al botón "next" del Splide
      const nextButton = splideRef.current.splide.Components.Arrows.arrows.next;
      const prevButton = splideRef.current.splide.Components.Arrows.arrows.prev;
      ...
      prevButton.innerHTML = prevButtonHTML;
    }
  }, []);
  ...
  }, []); // Dependencia actualizada para que el efecto se vuelva a ejecutar cuando cambie el tamaño de la ventana
